...
import * as Tickets from "./controllers"
...
function createRoutes(app: express.Express) {
  ...
  app.post('/tickets', urlencodedParser, Tickets.create);

  // Retrieve all tickets
  app.get('/tickets', Tickets.findAll);

  // Retrieve a single Note with noteId
  app.get('/tickets/:noteId', Tickets.findOne);

  // Update a Note with noteId
  app.put('/tickets/:noteId', Tickets.update);

  // Delete a Note with noteId
  app.delete('/tickets/:noteId', Tickets.deleteOne);
}
